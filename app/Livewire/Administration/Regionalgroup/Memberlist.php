...
class Memberlist extends Component
{
    ...
    public function boot()
    {
        ...
        $this->setModalIds(['del_modal', 'view_modal']);
    }
    ...
    {
        // build sql query
        $userquery = $this->rg->members()->with('userData');
        ...
        return view('administration.regionalgroup.partials.memberlist_lw')->with([
    ...
    public function delete_member(?int $account_id, bool $confirm = false)
    {
        ...
        if ($account_id == null) {
            $this->closeModal('del_modal');
            $this->delete_account_id = null;
        } elseif (!$confirm) {
            $this->delete_account_id = $account_id;
            $this->openModal('del_modal');
        } elseif ($this->delete_account_id == $account_id) {
            // remove from RG
            $this->closeModal('del_modal');
            $this->showNoty('Mitglied aus der RG entfernt.');
        }
        $this->closeModal('view_modal');
    }
