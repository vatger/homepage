...
const API_URI = window.location.origin + "/web_api/queryevents/" + EVENT_QUERY_COUNT;
...
getEvents()
    .then(async (events: Array<Event>) => {
        ...
        events.forEach((e: Event, i: number) => {
            event_container?.insertAdjacentHTML('beforeend', `
                    ...
                    <a href="${window.location.origin}/events/view/${e.id}">
                        <div class="card blog rounded border-0 shadow overflow-hidden">
                            <div class="position-relative">
                                ...
                                <div class="card-img-top loader-show overflow-hidden" id="event-banner-1" style="min-height: 200px; min-width: 356px; background: url('${e.banner}') center; background-size: cover;"></div>
                            </div>
