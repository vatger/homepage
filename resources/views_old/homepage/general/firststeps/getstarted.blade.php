            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="pages-heading">
                        <h2 style="color: white">@lang('first-steps.introduction.title')</h2>
                    </div>
                </div>
                <!--end col-->
            </div>
                        ...
                        <div class="card-body content">
                                            ...
                                            <div class="text-center">
                                                <ul class="nav nav-pills rounded-pill justify-content-center d-inline-block border py-1 px-2"
                                                    ...
                                                    <li class="nav-item d-inline-block">
                                                        <a class="nav-link px-3 rounded-pill monthly active" id="Pilot" data-bs-toggle="pill"
                                                            href="#pilot" role="tab" aria-controls="Month" aria-selected="true">@lang('first-steps.introduction.role-select.pilot-tab')</a>
                                                    </li>
                                                    <li class="nav-item d-inline-block">
                                                        <a class="nav-link px-3 rounded-pill yearly" id="Atc" data-bs-toggle="pill" href="#atc"
                                                            role="tab" aria-controls="Year" aria-selected="false">@lang('first-steps.introduction.role-select.atco-tab')</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="atc" role="tabpanel" aria-labelledby="Atc">
                                                    <div class="row">
                                                        ...
                                                        <a href="{{ route('getting-started.atc') }}"><button
                                                                class="btn btn-soft-primary w-100">@lang('first-steps.introduction.role-select.atco.button-content')</button></a>
                                                    </div>
                                                    <!--end row-->
                                                </div>
                                            </div>
                            ...
                            <div class="accordion mt-2 pt-2" id="general-section">
                                <div class="accordion-item rounded shadow bg-white mt-2">
                                    <h2 class="accordion-header" id="">
                                        <button class="accordion-button border-0 bg-light collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#newbieday-collapse" aria-expanded="false" aria-controls="newbieday-collapse">
                                            @lang('general.phrases.read-more')
                                        </button>
                                    </h2>
                                            ...
                                            <div class="rounded p-1 bg-light">
                                                <table class="w-100">
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="All places taken" alt=""><button type="button"
                                                                    class="btn btn-soft-info" disabled
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">Want to learn more? Head over to our Wiki and find interesting
                                                                articles all around
                                                                aviation.</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">Share your experience with fellow avaitors or aviation enthusiasts
                                                                on our forums or
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">Get a glimps at the activity on the network. Or just stalk others.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">The main reason for our hobby. We do not make any difference
                                                                between VFR or IFR,
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">We offer a lot of helping materials to give newer or non regional
                                                                members a better
                                                ...
                                                <div class="col-lg-4 col-md-6 pt-3">
                                                    <div class="card explore-feature border-0 rounded text-center bg-white shadow">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="text-muted mb-0">We are always focused on dataprotection and security for our
                                                                members. We do only
                                                                track data that is actually necessary for the purpose of flying / controlling on the
                                                                VATSIM network.</p>
                                                        </div>
                                                    </div>
                                                </div>
