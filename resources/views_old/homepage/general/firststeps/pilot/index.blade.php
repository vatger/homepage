            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="pages-heading">
                        <h2 style="color: white">@lang('first-steps.become-pilot.title')</h2>
                    </div>
                </div>
                <!--end col-->
            </div>
            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@lang('first-steps.become-pilot.breadcrumb')</li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="card blog blog-detail border-0 shadow rounded">
                        <div class="card-body content">
                            <h5>@lang('first-steps.become-pilot.title')</h5>
                                        ...
                                        <div class="accordion-item rounded shadow bg-white mt-2">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button border-0 bg-light @if ($i != 0) collapsed @endif"
                                                    ...
                                                    {{ $i + 1 }}. @lang('first-steps.become-pilot.content.' . $i . '.title')
                                                </button>
                                            </h2>
                                            <div id="collapse-{{ $i + 1 }}"
                                                ...
                                                <div class="accordion-body text-muted">
                                                    @lang('first-steps.become-pilot.content.' . $i . '.content.0')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="flex-1">
                                                <a>
                                                    <button type="button" class="btn btn-soft-primary navigation-button"
                                                        ...
                                                        data-id="{{ $i + 1 }}">@lang('first-steps.become-pilot.content.' . $i . '.title')</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
