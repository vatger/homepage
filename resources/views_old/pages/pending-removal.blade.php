...
@section('content')
    ...
    <section class="section">
        <div class="container">
            ...
            <h5>Löschung abbrechen</h5>
            <h5>Cancel deletion</h5>
            <p>
            ...
            <a class="btn btn-sm btn-danger" href="{{ route('member.removal-pending.cancel') }}">Löschung abbrechen / Cancel deletion</a>
        </div>
        <!--end container-->
    </section>
@endsection
