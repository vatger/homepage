...
const partners = [
    // {
    //   imgSrc: "/hero/VATSIM_Logo_Black.png",
    //   id: "vatsim",
    //   href: "https://vatsim.net",
    // },
    // {
    //   imgSrc: "/hero/VATEUD_Logo_Black.png",
    //   id: "vateud",
    //   href: "https://vateud.net",
    // },
    {
        imgSrc: '/hero/AEROSOFT_Logo_Black.png',
        id: 'aerosoft',
        href: 'https://aerosoft.de',
    },
    {
        imgSrc: '/hero/LHVIRTUAL_Logo_Black.png',
        id: 'lh-virtual',
        href: 'https://lh-virtual.com',
    },
];
                ...
                <div className="text-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="overflow-hidden">
                            <div className="flex justify-center space-x-10 sm:space-x-18">
                                {/* First set of logos */}
                                {partners.map((partner) => (
                                    <Link
                                        ...
                                        target="_blank"
                                    >
                                        <Card className="shrink-0 flex items-center justify-center h-16 w-40 opacity-80 hover:opacity-100 dark:hover:opacity-100 transition-opacity duration-300 border-0 shadow-none bg-transparent">
