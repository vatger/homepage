...
return [
    ...
    'aerodrome' => [
        ...
        'no-aircraft' => 'No aircraft are currently moving around this aerodrome.',
        'aircraft-summary' => 'Showing :shown of :total nearby aircraft.',
    ...
    'getting-started' => [
        ...
        'steps' => [
            ...
            'vatger-registration' => 'vatger Registration',
        ...
        'vatsim' => [
            ...
            'warning' => 'Do not create a second VATSIM account. Multiple accounts will lead to suspension. Contact VATSIM or vatger Support if you need help.',
        ...
        'vatger' => [
            'title' => 'vatger Registration',
            'text' => 'Now sign in to vatger using your newly created VATSIM account.',
        ],
    ],
    ...
    'banned' => [
        'title' => 'Blocked',
        'breadcrumb' => 'Blocked',
        'intro' => 'Your vatger account has been blocked. This can have various reasons.',
        'reason' => 'Reason:',
        'inactive' => 'Due to prolonged inactivity, your account was automatically set to “INACTIVE” in the central VATSIM database. vatger cannot access this database. You can reactivate your account at <a href="https://my.vatsim.net/reactivate">my.vatsim.net/reactivate</a>. If you encounter problems, please contact the <a href="https://membership.vatsim.net/">VATSIM Membership Department</a>.',
        ...
        'refresh' => 'If outdated data is displayed on the vatger website, <a href=":url">refresh it here</a>. New data may take up to 12 hours to become available.',
    ],

    'pending-removal' => [
        'title' => 'Data deletion in progress',
        'breadcrumb' => 'Pending Removal',
        'heading' => 'Your vatger data is being deleted',
        'text' => 'You requested the deletion of your vatger data or did not respond within the period specified in the statutes. We are therefore deleting the data stored by vatger. We can only delete data on vatger servers and cannot access the central VATSIM database. To delete your VATSIM account, contact VATSIM Support at support.vatsim.net. The process may take some time. Afterwards, you can create a new account with us if required.',
