...
return [
    'text-choose-cat' => 'Bitte wähle eine Anfragenkategorie',
    'text-choose-area' => 'Bitte wähle einen Bereich',
    'text-name' => 'Dein Name',
    'text-mail' => 'Deine E-Mailadresse',
    'text-cid' => 'Deine VATSIM-ID',
    ...
    'text-missing-subject' => 'Bitte Betreff eingeben',
    'text-wrong-mail' => 'Bitte gültige E-Mailadresse eingeben',
    'text-missing-mail' => 'Bitte E-Mailadresse eingeben',
    'text-missing-area' => 'Bitte Bereich auswählen',
    'text-missing-supporttype' => 'Bitte Anfragenkategorie auswählen',
    'text-error-kb' => 'Fehler in Knowledgebaseartikel',
    'text-credentials' => 'Zugangsdaten',
