...
return [
    'profile' => [
        ...
        'error' => [
            'account-inactive-text' => 'Dein VATSIM Account ist derzeit nicht aktiv. Es ist daher aktuell nicht möglich ein Foren-/Teamspeak Konto bei VATSIM Germany anzulegen. 
