        ...
        <form wire:submit="removeBan">
            <div class="modal-content rounded shadow border-0">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn-danger" wire:loading.class="disabled" data-dismiss="modal" data-bs-dismiss="modal" wire:click="removeBan()">Löschen</button>
                </div>
            </div>
        </form>
    </div>
