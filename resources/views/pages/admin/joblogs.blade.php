<div class="container-fluid">
    ...
    <div wire:poll.visible.5s>
        <x-layouts.admin.card>
            <x-layouts.admin.card-header position="left" title="Queued Jobs" :subtitle="\App\Models\Tech\Job::count()"></x-layouts.admin.card-header>

            <div class="p-4 table-responsive">
                <table class="table table-center bg-white mb-0">
                    <thead>
                    <th class="border-bottom p-3" style="white-space: nowrap">queue data</th>
                    </thead>
                    <tbody>
                    @foreach ($qjobs as $j)
                        <tr>
