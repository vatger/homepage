                                ...
                                <div class="features feature-primary d-flex justify-content-between align-items-center bg-white">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            ...
                                            <p class="fs-5 text-dark fw-bold mb-0" id="element-count">{{ $aerodromes->total() }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 mt-2" style="text-align: right">
                                <li class="list-inline-item" style="width: 100%">
                                    <div class="form-icon position-relative">
                                        ...
                                        <input name="search_string" id="aerodrome-search-input" class="form-control ps-5" type="text"
                            ...
                            <div class="row p-4 pt-0 table-responsive">
                                <table class="table table-center bg-white mb-0">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="border-bottom p-3 w-25">ICAO | IATA</th>
                                            <th class="border-bottom p-3 w-25">Aktiv</th>
                                            <th class="border-bottom p-3 w-25">Aktion</th>
                                        </tr>

                                    </thead>
                                    <tbody id="aerodrome-list-content">
                                ...
                                <ul class="pagination mb-0 mt-4" style="display: none">
                                    ...
                                    <li class="page-item active"><a class="page-link" id="current-page-indicator"
                                            href="javascript:void(0)">{{ $aerodromes->currentPage() }}</a></li>
                                    ...
                                    <li class="page-item" id="page-item-last" data-action="last"><a class="page-link"
                                            href="javascript:void(0)">{{ $aerodromes->lastPage() }}</a></li>
...
@push('custom-script')
    <script>
        const options = {
            currentPage: {{ $aerodromes->currentPage() }},
            maxPage: {{ $aerodromes->lastPage() }},
            ajaxSearchUrl: "{{ route('api.administration.navigation.aerodromes.search') }}",
            loadPaginatedUrl: "{{ route('api.administration.navigation.aerodromes.getpaginated') }}",

            list_content: $("#aerodrome-list-content"),
            search_input: $("#aerodrome-search-input"),
        };
        ...
        new Pagination(
            ...
            (value, container) => {
                ...
                container.append(`<tr class="text-center">
                        <td>${value['name']}</td>
                        <td>${value['icao'] + (value['iata'] ? " | " + value['iata'] : "" )}</td>
                        <td>${(value['active'] === 1) ? `<span class="badge bg-soft-success">Ja</span>` : `<span class="badge bg-soft-warning">Nein</span>` } </td>
                        <td>
                            <a href="/administration/navigation/aerodromes/${value['id']}" class="btn btn-sm btn-soft-primary p-1 px-3" style="font-size: 15px"><i class="mdi mdi-eye-outline"></i></a>
                        </td>
                    </tr>`);
            }
        );
