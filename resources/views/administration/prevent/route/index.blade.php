            ...
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                    <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                        ...
                        <li class="breadcrumb-item text-capitalize active" aria-current="page">Routes</li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="features feature-primary d-flex justify-content-between align-items-center bg-white">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-3">
                                            <h6 class="mb-0 text-muted">Routes</h6>
                                ...
                                <table class="table table-center bg-white mb-0">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="border-bottom p-3">Öffentlich</th>
                                            <th class="border-bottom p-3">In Reihenfolge</th>
                                            <th class="border-bottom p-3">Flight Rules</th>
                                            <th class="border-bottom p-3">Start (UTC)</th>
                                            <th class="border-bottom p-3">Ende (UTC)</th>
                                    ...
                                    <tbody id="events-list-content">
                                        @foreach ($routes as $r)
                                            <tr class="text-center">
                                                ...
                                                <td>{{ $r->begins_at->format('d.m.Y H:i') }}</td>
                                                <td>{{ $r->ends_at->format('d.m.Y H:i') }}</td>
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="btn group">
                                                        <a href="{{ route('administration.prevent.route.show', $r) }}"
                                                            class="btn btn-sm btn-soft-primary p-1 px-3" style="font-size: 15px"><i
                                                                class="mdi mdi-eye-outline"></i></a>
                                                        <a href="{{ route('administration.prevent.route.getaccounts', $r) }}"
                                                            class="btn btn-sm btn-soft-primary p-1 px-3" style="font-size: 15px"><i
                    ...
                    <div class="bg-white px-3 rounded box-shadow">
                        <form id="route-form">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        <lable class="form-label">In Reihenfolge</lable>
                                        <span class="text-danger"> *</span>
                                        <div class="form-icon position-relative">
                                            <select type="text" class="form-control" id="route-inorder" name="require_order">
                                                <option value="1">Ja</option>
                                                <option value="0">Nein</option>
                                            </select>
                                        </div>
