                ...
                <tbody>
                    @foreach ($members as $member)
                        <tr>
                            ...
                            <td>{{ $member->pivot->chief ? 'Leitender-Mentor ' : '' }} {{ $member->pivot->senior ? 'Senior-Mentor' : '' }}</td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button class="btn btn-sm {{ $member->pivot->senior ? 'btn-soft-danger' : 'btn-soft-success' }}"
                                        wire:click="toggle_deputy({{ $member->id }})">Senior</button>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12" style="text-align: right">
                <li class="list-inline-item" style="width: 100%">
                    <div class="">Mentor hinzufügen:</div>
