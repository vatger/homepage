<div>
    ...
    <div id="del_modal_guest" class="modal fade" tabindex="-1" aria-modal="true" role="dialog" aria-hidden="true">
                        ...
                        <div>
                            @if (!empty($delete_account_id))
                                ...
                                <div class="btn-group mt-2">
                                    ...
                                    <button class="btn btn-soft-danger" wire:click="delete_member({{ $delete_account?->id }}, true)">Gast-Mitglied
                                        rauswerfen</button>
                                </div>
                            @endif
                        </div>
    ...
    <div id="view_modal_guest" class="modal fade" tabindex="-1" aria-modal="true" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded shadow border-0">
                <div class="modal-body py-5">
                    <div class="text-center">
                        ...
                        <div>
                            @if (!empty($details_account_id))
                                <h4 class="mt-4">Gastmitglied, {{ $details_account?->username }}</h4>
                                <div class="mt-4">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-1">
