    ...
    <div class="container-fluid">
        <div class="layout-specing">
            <div class="d-md-flex justify-content-between align-items-center">
                <h5 class="mb-0">Membership Dashboard</h5>
            ...
            <div class="row row-cols-xl-2 row-cols-1">
                @foreach ($regionalgroups as $rg)
                    <div class="col mt-4">
                        <a href="{{ route('administration.regionalgroup.view', ['regionalgroup' => $rg->id]) }}"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-1 ms-3">
                                    <h6 class="mb-0 text-muted">{{ $rg->fir?->name }}</h6>
                                    <p class="fs-5 text-dark fw-bold mb-0">{{ $rg->name }}</p>
                                </div>
                            </div>
                        </a>
                    </div>
