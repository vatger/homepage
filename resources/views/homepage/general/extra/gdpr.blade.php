...
@section('content')
    <!-- Hero Start -->
    <section class="bg-half-170 bg-light d-table w-100" style='background-image: url("{{ asset('images/gdpr/gdpr_1.png') }}")'>
        <div class="bg-overlay" style="background-color: rgb(30 41 58 / 70%)"></div>
        <div class="container">
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="pages-heading">
                        <h2 style="color: white">VATSIM Germany @lang('general.gdpr')</h2>
                    </div>
                </div>
                <!--end col-->
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="card shadow border-0 rounded">
                        <div class="card-body">
                            <h4 class="pt-2">Datenschutzerklärung</h4>
                            <h4 class="pt-2" id="dsg-general-intro"></h4>
                            <p class="border-bottom pb-2">Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der
                                Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) im Rahmen der Erbringung unserer Leistungen
                                sowie innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie
                            ...
                            <h4 class="pt-2" class="pt-2" id="dsg-general-controller">Verantwortlicher</h4>
                            <p class="border-bottom pb-4">
                                <span class="tsmcontroller">
                                    VATSIM Germany<br>Germany<br><br>
                                    director@vatsim-germany.org<br>
                                    Repräsentant der Gruppe: Sebastian Klietz (1331358)<br>
                                    Link zum Impressum: https://vatsim-germany.org/impressum<br><br>
                                    Kontakt Datenschutzbeauftragte/r: datenschutz@vatsim-germany.org
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-general-datatype">Arten der verarbeiteten Daten</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-datasubjects">Kategorien betroffener Personen</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-purpose">Zweck der Verarbeitung</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-terms">Verwendete Begrifflichkeiten </h4>
                            <p class="border-bottom pb-4">
                                ...
                                identifizierbaren natürlichen Person zugewiesen werden.<br><br>
                                ...
                                Person zu analysieren oder vorherzusagen.<br><br>
                            ...
                            <h4 class="pt-2" id="dsg-general-legalbasis">Maßgebliche Rechtsgrundlagen</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-securitymeasures">Sicherheitsmaßnahmen</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-coprocessing">Zusammenarbeit mit Auftragsverarbeitern, gemeinsam
                                Verantwortlichen und Dritten</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-general-thirdparty">Übermittlungen in Drittländer</h4>
                            <p class="border-bottom pb-4">
                                ...
                                von Diensten Dritter oder Offenlegung, bzw. Übermittlung von Daten an andere Personen oder Unternehmen geschieht,
                                erfolgt dies nur, wenn es zur Erfüllung unserer (vor)vertraglichen Pflichten, auf Grundlage Ihrer Einwilligung,
                                aufgrund einer rechtlichen Verpflichtung oder auf Grundlage unserer berechtigten Interessen geschieht.
                                Vorbehaltlich ausdrücklicher Einwilligung oder vertraglich erforderlicher Übermittlung, verarbeiten oder lassen
                                ...
                                vertraglicher Verpflichtung durch sogenannte Standardschutzklauseln der EU-Kommission, dem Vorliegen von
                                Zertifizierungen oder verbindlichen internen Datenschutzvorschriften verarbeiten (Art. 44 bis 49 DSGVO, <a
                            ...
                            <h4 class="pt-2" id="dsg-general-rightssubject">Rechte der betroffenen Personen</h4>
                            <p class="border-bottom pb-4">
                                ...
                                oder die Berichtigung der Sie betreffenden unrichtigen Daten zu verlangen.<br><br>
                                ...
                                der gesetzlichen Vorgaben zu erhalten und deren Übermittlung an andere Verantwortliche zu fordern. <br><br>
                            ...
                            <h4 class="pt-2" id="dsg-general-revokeconsent">Widerrufsrecht</h4>
                            <p class="border-bottom pb-4">
                                Sie haben das Recht, erteilte Einwilligungen mit Wirkung für die Zukunft zu widerrufen.
                            </p>

                            <h4 class="pt-2" id="dsg-general-object">Widerspruchsrecht</h4>
                            <p class="border-bottom pb-4">
                                <strong>
                            ...
                            <h4 class="pt-2" id="dsg-general-cookies">Cookies und Widerspruchsrecht bei Direktwerbung</h4>
                            <p class="border-bottom pb-4">
                                ...
                                Cookie-Einwilligung), ist die Rechtsgrundlage dieser Verarbeitung Art. 6 Abs. 1 lit. a. DSGVO. Ansonsten werden
                                die personenbezogenen Cookies der Nutzer entsprechend den nachfolgenden Erläuterungen im Rahmen dieser
                                ...
                                Einsatz von Cookies zur Erbringung unserer vertragsbezogenen Leistungen erforderlich ist, gem. Art. 6 Abs. 1 lit.
                                b. DSGVO, bzw. sofern der Einsatz von Cookies für die Wahrnehmung einer Aufgabe, die im öffentlichen Interesse
                                liegt erforderlich ist oder in Ausübung öffentlicher Gewalt erfolgt, gem. Art. 6 Abs. 1 lit. e. DSGVO,
                                verarbeitet.<br><br>
                            ...
                            <h4 class="pt-2" id="dsg-general-erasure">Löschung von Daten</h4>
                            <p class="border-bottom pb-4">
                                ...
                                keine gesetzlichen Aufbewahrungspflichten entgegenstehen. <br><br>
                            ...
                            <h4 class="pt-2" id="dsg-general-changes">Änderungen und Aktualisierungen der Datenschutzerklärung</h4>
                            <p class="border-bottom pb-4">
                            ...
                            <h4 class="pt-2" id="dsg-organisation">Erbringung unserer satzungs- und geschäftsgemäßen Leistungen</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">
                                    ...
                                    Bankverbindung, Zahlungshistorie, etc.).<br><br>
                            ...
                            <h4 class="pt-2" id="dsg-registration">Registrierfunktion</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">
                                    ...
                                    Nutzerkontos verarbeitet. Zu den verarbeiteten Daten gehören insbesondere die Login-Informationen (Name,
                                    Passwort sowie eine E-Mailadresse). Die im Rahmen der Registrierung eingegebenen Daten werden für die Zwecke der
                                    Nutzung des Nutzerkontos und dessen Zwecks verwendet. <br><br>
                                    ...
                                    Vertragsdauer gespeicherten Daten des Nutzers unwiederbringlich zu löschen.<br><br>
                                    ...
                                    lit. c. DSGVO. Die IP-Adressen werden spätestens nach 7 Tagen anonymisiert oder gelöscht.<br>
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-comments">Kommentare und Beiträge</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">
                                    ...
                                    unserer Sicherheit, falls jemand in Kommentaren und Beiträgen widerrechtliche Inhalte hinterlässt
                                    (Beleidigungen, verbotene politische Propaganda, etc.). In diesem Fall können wir selbst für den Kommentar oder
                                    Beitrag belangt werden und sind daher an der Identität des Verfassers interessiert.<br><br>
                                    Des Weiteren behalten wir uns vor, auf Grundlage unserer berechtigten Interessen gem. Art. 6 Abs. 1 lit. f.
                                    ...
                                    Dauer zu speichern und Cookies zu verwenden, um Mehrfachabstimmungen zu vermeiden.<br><br>
                            ...
                            <h4 class="pt-2" id="dsg-subscribetocomments">Kommentarabonnements</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">
                                    ...
                                    speichern wir den Anmeldezeitpunkt nebst der IP-Adresse der Nutzer und löschen diese Informationen, wenn Nutzer
                                    sich von dem Abonnement abmelden.<br><br>
                                    Sie können den Empfang unseres Abonnements jederzeit kündigen, d.h. Ihre Einwilligungen widerrufen. Wir können
                            ...
                            <h4 class="pt-2" id="dsg-musicpodcast-soundcloud">Soundcloud</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">
                                    Unsere Podcasts werden auf der Plattform „Soundcloud“, angeboten von SoundCloud Limited, Rheinsberger Str.
                                    76/77, 10115 Berlin, Deutschland gespeichert und werden von dieser aus Platform wiedergegeben.<br><br>
                                    Zu diesem Zweck binden wir sog. Soundcloud-Widgets in unsere Website ein. Dabei handelt es sich um
                                    Abspielsoftware, mit der Nutzer die Podcasts abspielen können. Hierbei kann Soundcloud messen, welche Podcasts
                                    ...
                                    entsprechen, verarbeitet werden. Im Fall von Nutzern, die bei Soundcloud registriert sind, kann Soundcloud die
                                    Hörinformationen deren Profilen zuordnen.<br><br>
                                    Die Nutzung erfolgt auf Grundlage unserer berechtigten Interessen, d.h. Interesse an einer sicheren und
                                    effizienten Bereitstellung, Analyse sowie Optimierung unseres Audioangebotes gem. Art. 6 Abs. 1 lit. f. DSGVO.
                                    <br><br>
                                    Weitere Informationen und Widerspruchsmöglichkeiten finden sich in der Datenschutzerklärung von Soundcloud: <a
                                        target="_blank" href="https://soundcloud.com/pages/privacy">https://soundcloud.com/pages/privacy</a>.
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-contact">Kontaktaufnahme</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Bei der Kontaktaufnahme mit uns (z.B. per Kontaktformular, E-Mail, Telefon oder
                                    ...
                                    ("CRM System") oder vergleichbarer Anfragenorganisation gespeichert werden.<br> <br>
                                    Wir löschen die Anfragen, sofern diese nicht mehr erforderlich sind. Wir überprüfen die Erforderlichkeit alle
                                    zwei Jahre; Ferner gelten die gesetzlichen Archivierungspflichten.</span>
                            </p>

                            <h4 class="pt-2" id="dsg-hostingprovider">Hosting und E-Mail-Versand</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Die von uns in Anspruch genommenen Hosting-Leistungen dienen der
                            ...
                            <h4 class="pt-2" id="dsg-logfiles">Erhebung von Zugriffsdaten und Logfiles</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir, bzw. unser Hostinganbieter, erhebt auf Grundlage unserer berechtigten
                                    ...
                                    Löschung ausgenommen.</span>
                            </p>

                            <h4 class="pt-2" id="dsg-cdn-cloudflare">Content-Delivery-Network von Cloudflare</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir setzen ein so genanntes "Content Delivery Network" (CDN), angeboten von
                                    Cloudflare, Inc., 101 Townsend St, San Francisco, CA 94107, USA, ein. Cloudflare ist unter dem
                                    ...
                                    einzuhalten (<a target="_blank"
                                        href="https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&amp;status=Active">https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&amp;status=Active</a>).<br>
                                    <br>
                                    Ein CDN ist ein Dienst, mit dessen Hilfe Inhalte unseres Onlineangebotes, insbesondere große Mediendateien, wie
                                    ...
                                    Aufrechterhaltung der Sicherheit und Funktionsfähigkeit des CDN.<br> <br>
                                    Die Nutzung erfolgt auf Grundlage unserer berechtigten Interessen, d.h. Interesse an einer sicheren und
                                    effizienten Bereitstellung, Analyse sowie Optimierung unseres Onlineangebotes gem. Art. 6 Abs. 1 lit. f. DSGVO.
                                    <br> <br>
                                    Weitere Informationen erhalten Sie in der Datenschutzerklärung von Cloudflare:&nbsp;<a target="_blank"
                                        href="https://www.cloudflare.com/security-policy">https://www.cloudflare.com/security-policy</a>.
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-ga-googleanalytics">Google Analytics</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir setzen Google Analytics, einen Webanalysedienst der Google Ireland Limited,
                                    Gordon House, Barrow Street, Dublin 4, Irland („Google“) ein. Google verwendet Cookies. Die durch das Cookie
                                    erzeugten Informationen über Benutzung des Onlineangebotes durch die Nutzer werden in der Regel an einen Server
                                    von Google in den USA übertragen und dort gespeichert.<br> <br>
                                    ...
                                    einen Server von Google in den USA übertragen und dort gekürzt.<br> <br>
                                    ...
                                    wirtschaftlichem Betrieb unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) verarbeitet.<br> <br>
                                    Soweit Daten in den USA verarbeitet werden, weisen wir daraufhin, dass Google unter dem Privacy-Shield-Abkommen
                                    zertifiziert ist und hierdurch zusichert, das europäische Datenschutzrecht einzuhalten (<a target="_blank"
                                    ...
                                    in der Datenschutzerklärung von Google (<a target="_blank"
                                        href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>)
                                    sowie in den
                                    Einstellungen
                                    für die Darstellung von Werbeeinblendungen durch Google <a target="_blank"
                            ...
                            <h4 class="pt-2" id="dsg-socialmedia">Onlinepräsenzen in sozialen Medien</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke und Plattformen, um
                                    mit den dort aktiven Kunden, Interessenten und Nutzern kommunizieren und sie dort über unsere Leistungen
                                    informieren zu können.<br> <br>
                                    ...
                                    weisen wir darauf hin, dass sie sich damit verpflichten, die Datenschutzstandards der EU einzuhalten.<br> <br>
                                    ...
                                    verweisen wir auf die nachfolgend verlinkten Angaben der Anbieter.<br> <br>
                                    ...
                                    Hilfe benötigen, dann können Sie sich an uns wenden.<br> <br>
                                    ...
                                    Irland) auf Grundlage einer <a target="_blank"
                                        ...
                                        Verarbeitung
                                        personenbezogener Daten</a> - Datenschutzerklärung: <a target="_blank"
                                    ...
                                    , Opt-Out: <a target="_blank"
                                        ...
                                        target="_blank" href="http://www.youronlinechoices.com">http://www.youronlinechoices.com</a>, Privacy Shield:
                                    <a target="_blank"
                                    ...
                                    <a target="_blank" href="https://wakelet.com/privacy.html">https://wakelet.com/privacy.html</a>.<br> <br>
                                    - Soundcloud (SoundCloud Limited, Rheinsberger Str. 76/77, 10115 Berlin, Deutschland) - Datenschutzerklärung/
                                    Opt-Out: <a target="_blank" href="https://soundcloud.com/pages/privacy">https://soundcloud.com/pages/privacy</a>.
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-thirdparty-einleitung">Einbindung von Diensten und Inhalten Dritter</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir setzen innerhalb unseres Onlineangebotes auf Grundlage unserer berechtigten
                            ...
                            <h4 class="pt-2" id="dsg-thirdparty-vimeo">Vimeo</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir können die Videos der Plattform “Vimeo” des Anbieters Vimeo Inc., Attention:
                                    Legal Department, 555 West 18th Street New York, New York 10011, USA, einbinden. Datenschutzerklärung: <a
                                        target="_blank" href="https://vimeo.com/privacy">https://vimeo.com/privacy</a>. Wir weisen darauf hin, dass
                                    ...
                                    Opt-Out-Möglichkeiten für Google-Analytics (<a target="_blank"
                                        href="http://tools.google.com/dlpage/gaoptout?hl=de">http://tools.google.com/dlpage/gaoptout?hl=de</a>) oder
                                    die Einstellungen von Google für die Datennutzung zu Marketingzwecken (<a target="_blank"
                                        href="https://adssettings.google.com/">https://adssettings.google.com/</a>).
                                </span>
                            </p>

                            <h4 class="pt-2" id="dsg-thirdparty-youtube">Youtube</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir binden die Videos der Plattform “YouTube” des Anbieters Google Ireland
                                    Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Datenschutzerklärung: <a target="_blank"
                            ...
                            <h4 class="pt-2" id="dsg-thirdparty-googlefonts">Google Fonts</h4>
                            <p class="border-bottom pb-4">
                                <span class="ts-muster-content">Wir binden die Schriftarten ("Google Fonts") des Anbieters Google Ireland
                                    Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Nach Angaben von Google werden die Daten der Nutzer
                                    allein zu Zwecken der Darstellung der Schriftarten im Browser der Nutzer verwendet. Die Einbindung erfolgt auf
                                    Grundlage unserer berechtigten Interessen an einer technisch sicheren, wartungsfreien und effizienten Nutzung
                                    von Schriftarten, deren einheitlicher Darstellung sowie Berücksichtigung möglicher lizenzrechtlicher
                                    Restriktionen für deren Einbindung. Datenschutzerklärung: <a target="_blank"
                                        href="https://www.google.com/policies/privacy/">https://www.google.com/policies/privacy/</a>.
                                </span>
                            </p>
                            <a href="https://datenschutz-generator.de" rel="nofollow" target="_blank" class="dsg1-6">Erstellt mit
