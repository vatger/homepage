                                            ...
                                            @if (is_array($chart))
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @if (isset($chart['link']))
                                                            {{-- THESE ARE AIP LINKS --}}
                                                            <a href="{{ $chart['link'] }}" class="nav-link" target="_blank"><button type="button"
                                                                    class="btn btn-sm btn-soft-primary">Download</button></a>
                                                        @else
                                                            {{-- LOCAL (NAV SVN) CHARTS --}}
                                                            @if ($chart['fri'] == 'vfr' && ($token = \App\Libraries\Authorization\ChartAuthorization::grantAccessToken($chart['id'])))
                                                                <a href="{{ $chart['href'] }}?token={{ $token }}" class="nav-link"
                                                                    target="_blank"><button type="button"
                                                                        class="btn btn-sm btn-soft-primary">Download</button></a>
                                                            @elseif ($chart['fri'] == 'ifr')
                                                                <a href="{{ $chart['href'] }}" class="nav-link" target="_blank"><button type="button"
                                                                        class="btn btn-sm btn-soft-primary">Download</button></a>
                                                            @else
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            {{-- LOCAL (NAV SVN) CHARTS --}}
                                                            @if ($chart->fri == 'vfr' && ($token = \App\Libraries\Authorization\ChartAuthorization::grantAccessToken($chart)))
                                                                <a href="{{ $chart->href }}?token={{ $token }}" class="nav-link"
                                ...
                                <div class="mt-4">
                                    @if ($aerodrome->useChartfox)
                                        <button onclick="showChartfoxModal()" type="button" class="btn btn-soft-primary"
                                            style="width: 90%; margin-left: 5%">ChartFox <svg xmlns="http://www.w3.org/2000/svg" width="14"
